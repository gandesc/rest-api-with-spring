...
public final class SpringSecurityUtil {
    ...
    public static SpringSecurityUser getCurrentUser() {
        final Authentication currentAuthentication = getCurrentAuthentication();
        if (currentAuthentication == null) {
            return null;
        }
        final Object user = currentAuthentication.getPrincipal();
        if (user == null) {
            return null;
        }
    ...
    public static String getUuidOfCurrentUser() {
        final SpringSecurityUser currentUser = getCurrentUser();
        if (currentUser == null) {
            return null;
        }
