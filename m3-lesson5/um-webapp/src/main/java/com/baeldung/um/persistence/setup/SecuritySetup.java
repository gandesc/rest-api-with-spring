...
public class SecuritySetup implements ApplicationListener<ContextRefreshedEvent> {
    ...
    final void createUsers() {
        ...
        createUserIfNotExisting(Um.ADMIN_EMAIL, Um.ADMIN_PASS, Sets.<Role> newHashSet(roleAdmin, roleDoctor));
        createUserIfNotExisting(Um.USER_EMAIL, Um.USER_PASS, Sets.<Role> newHashSet(roleUser, roleNurse));
    }
